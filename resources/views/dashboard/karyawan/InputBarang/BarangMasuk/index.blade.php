...
<div class="container rounded bg-white mt-5">
        ...
        <h1 class="title">Form Barang Masuk</h1>
        ...
        <div class="row justify-content-end mb-2 me-5">
            <div class="col-md-5">
                <form action="/dashboard/InputBarang/BarangMasuk">
        ...
        <a href="/dashboard/InputBarang/BarangMasuk/create" class="btn btn-primary mb-3"><span data-feather="plus"></span> Tambah</a>
    ...
    <div class="table-responsive fs-6">
            ...
            <tbody>
                ...
                <form action="{{ url('/dashboard/InputBarang/BarangMasuk/'.$item->id)  }}"
